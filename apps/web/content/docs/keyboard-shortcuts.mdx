...
| `Ctrl+B` / `⌘+B` | Toggle the workspace sidebar             |
...
| `Ctrl+1-9` / `⌘+1-9`         | Switch to tab by number (1-9) |

## Sidebar

| Shortcut                 | Description                 |
| ------------------------ | --------------------------- |
| `Ctrl+Shift+E` / `⌘+⇧+E` | Focus Schemas sidebar       |
| `Ctrl+Shift+Y` / `⌘+⇧+Y` | Focus Saved Queries sidebar |
| `Ctrl+Shift+D` / `⌘+⇧+D` | Focus Dashboards sidebar    |
...
| `Ctrl+F` / `⌘+F` | Filter by focused cell value |
...
| Shortcut                                 | Description                    |
| ---------------------------------------- | ------------------------------ |
| `Ctrl+Shift+L` / `⌘+⇧+L`                 | Clear all filters              |
| `Ctrl+Shift+↑` / `⌘+⇧+↑`                 | Sort focused column ascending  |
| `Ctrl+Shift+↓` / `⌘+⇧+↓`                 | Sort focused column descending |
| `Ctrl+Shift+Backspace` / `⌘+⇧+Backspace` | Clear focused column sort      |
