...
import { useAlterTable, useDeleteTable, useTableIntrospection } from '@renderer/api/queries/schema'
...
import { FileCode2, FileDown, MoreVertical, PencilIcon, Trash2 } from 'lucide-react'
